            ...
            <div className="container mx-auto flex justify-between pl-4 pr-4">
                <div className={styles.contactInfo}>
                    <p>
                        Contact Number:{" "}
                        <span>
                            <a href="tell:+918040245425">+91 8040245425</a>
                        </span>
                    </p>
                    <p>
                        Email:{" "}
                        <span>
                            <a href="mailto:support@accioesops.com">support@accioesops.com</a>
                        </span>
                    </p>
                </div>
                <button className={styles.callButton} onClick={openModal}>
                    Book a Call Now
                </button>
            </div>
            <Modal

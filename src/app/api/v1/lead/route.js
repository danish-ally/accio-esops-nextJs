...
export async function GET(request) {
  ...
  try {
    ...
    //     { companySize: { $regex: new RegExp(regexSearch, 'i') } },
...
// Apply the tokenValidatorMiddleware to the GET request
// export const GET = tokenValidatorMiddleware(async function (request) {
//   try {
//     await connectMongoDB();
